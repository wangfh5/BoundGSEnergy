...
function add_rdm8_rg_hierarchy!(
    ...
    super_charges,
    ;
    local_link_scale=STRUCTURED_RG_RDM8_LOCAL_LINK_SCALE,
    omega4_link_scale=STRUCTURED_RG_RDM8_OMEGA4_LINK_SCALE,
    recursion_scale=STRUCTURED_RG_RDM8_RECURSION_SCALE,
)
    ...
    omega4_link_count = add_scaled_symmetric_equalities!(
        model,
        omega[1] - compression * rho4 * compression',
